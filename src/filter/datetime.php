...
class DateTime extends \Filter\Text
{
    ...
    public function getValue()
    {
        ...
        //$view[] = new \View\Ext\DateTimeInput( $columnValue, Request::get( $columnValue ), 'small filterInput' );
        ...
        //$view[] = $hide = new \View\Ext\DateTimeInput( $columnValue . 'Final', Request::get( $columnValue . 'Final' ), 'small filterInput filterDataFinal' );
        $view[] = $hide = new \View\InputText( $columnValue . 'Final', Request::get( $columnValue . 'Final' ), 'small filterInput filterDataFinal' );

        //$input->setData( 'mask-function', 'maskDateTime' );
        //$hide->setData( 'mask-function', 'maskDateTime' );
