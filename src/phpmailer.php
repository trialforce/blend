...
class PHPMailer
{
    ...
    function SetLanguage($langcode = 'en', $lang_path = 'language/')
    {
        ...
        $PHPMAILER_LANG = array(
            ...
            'file_access' => 'Impossível acessar arquivo: ',
            'file_open' => 'Erro de arquivo: impossível abrir arquivo: ',
            'from_failed' => 'Endereço falhou: ',
            'instantiate' => 'Impossível instanciar função \'mail\'',
            'invalid_address' => 'Endereço inválido',
            'mailer_not_supported' => ' enviador não suportado.',
            'provide_address' => 'É necessário informar ao menos um endereço.',
            'recipients_failed' => 'Erro de SMTP: endereços falharam: ',
            'signing' => 'Erro de assinatura: ',
            'smtp_connect_failed' => 'Impossível enviar email, problemas ao conectar com servidor. Verifique usuário e senha!',
            'smtp_error' => 'SMTP erro de servidor: ',
            'variable_set' => 'Impossível definir variável: '
        );
...
class SMTP
{
     ...
     * @return bool
     */
    public function Connect($host, $port = 0, $timeout = 5, $options = array())
    {
        ...
        $errno = 0;
        $errstr = '';
        //fork para funcionar no php 5.6 => 7.0
        $options['ssl'] = array(
            'verify_peer' => false,
