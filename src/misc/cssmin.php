...
class CssMin
{
     ...
     * @return string
     */
    protected function _selectorsCB($matchesatches)
    {
        // remove ws around the combinators
        return preg_replace('/\\s*([,>+~])\\s*/', '$1', $matchesatches[0]);
    }
     ...
     * @return string
     */
    protected function _commentCB($matches)
    {
     ...
     * @return string
     */
    protected function _fontFamilyCB($matches)
    {
        // Issue 210: must not eliminate WS between words in unquoted families
        $pieces = preg_split('/(\'[^\']+\'|"[^"]+")/', $matches[1], -1, PREG_SPLIT_DELIM_CAPTURE | PREG_SPLIT_NO_EMPTY);
        $out = 'font-family:';
